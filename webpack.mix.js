...
mix.scripts(
    ...
    .scripts(
        ...
        "public/js/components/select.js"
    )
    .scripts(
    ...
    .scripts(
        "resources/js/templates/bundles/index.js",
        "public/js/templates/bundles/index.js"
    )
    .scripts(
        "resources/js/templates/auth/register.js",
        "public/js/templates/auth/register.js"
    )
    ...
    .sass(
        "resources/sass/templates/apps/index.scss",
        "public/css/templates/apps"
    )
    .sass(
        "resources/sass/templates/apps/create.scss",
        "public/css/templates/apps"
    )
    ...
    .sass(
        "resources/sass/templates/bundles/show.scss",
        "public/css/templates/bundles"
    )
    .sass(

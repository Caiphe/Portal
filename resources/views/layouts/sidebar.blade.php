...
<body>
    ...
    <div class="wrapper">
        ...
        <main id="main">
            <button class="light small">hello</button><br>
            <button class="outline light small">hello</button><br>
            <button class="lightest small">hello</button><br>
            <button class="outline lightest small">hello</button>
            @yield("content")
        </main>
    </div>
    <x-footer/>

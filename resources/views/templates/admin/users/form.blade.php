...
<div class="editor-field half">
    ...
    <label class="editor-field-label">
        <h3>Email address</h3>
        <input type="text" name="email" id="email" placeholder="Email" @if (Route::currentRouteName() == 'admin.user.edit') readonly @endif value="{{ $user->email ?? old('email') }}" autocomplete="off" maxlength="140">
    </label>

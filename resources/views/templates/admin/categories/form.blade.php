...
<div class="editor-field">
    <h2>Title</h2>
    <input type="text" class="long" name="title" placeholder="Title" value="{{ $category->title ?? '' }}" autocomplete="off">
</div>

<div class="editor-field">
    <h2>Heading</h2>
    <input type="text" class="long" name="heading-title" value="{{ $content['heading'][0]['title'] ?? '' }}" autocomplete="off">
</div>

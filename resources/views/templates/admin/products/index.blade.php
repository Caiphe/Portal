...
@section('content')
    ...
    <div id="table-data">
        @include('components.admin.list', [
            'collection' => $products,
            'fields' => ['Name' => 'display_name', 'Access level' => 'access', 'Environments' => 'environments|splitToTag:,|addClass:not-on-mobile', 'Category' => 'category.title|addClass:not-on-mobile'],
            'modelName' => 'product'
        ])
    </div>
@endsection

...
<x-dialog-box dialogTitle="PRIVACY OVERVIEW" id="cookie-policy-preferences">
    ...
    <div class="bottom-shadow-container button-container mt-40">
        <button id="cookie-policy-accept" class="btn primary">SAVE & ACCEPT</button>
    </div>
</x-dialog-box>

document.addEventListener('DOMContentLoaded', function () {
    ...
    const restrictedKeywords = ['sendermsisdn', 'originalChannelID', 'partnername', 'PermittedSenderIDs', 'PermittedPlanIDs', 'AutoRenewAllowed', 'country', 'teamname', 'location', 'description', 'displayname', 'notes' ];

    ...
    public function approve(App $app)
    {
        ...
        if($app->team){
            ...
            foreach($appUsers as $user){
                Notification::create([
                    'user_id' => $user,
                    'notification' => "Your App <strong>{$app->display_name}</strong> from your team {$app->team->name} has been updated. Please navigate to your <a href='/teams/{$app->team->id}/team'>team</a> for more info.",
                ]);
            }
        }
